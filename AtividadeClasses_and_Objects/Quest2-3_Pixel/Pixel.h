...
{
private:
	unsigned int coordX = NULL;
	unsigned int coordY = NULL;

public:
	Pixel() = default;

	Pixel(unsigned int coordX, unsigned int coordY);

	unsigned getX();

	unsigned getY();

	void setCoordX(unsigned int xCoord);

	void setCoordY(unsigned yCoord);
