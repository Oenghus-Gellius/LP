...
código, título e o preço do livro; nome do autor e da editora. 
Use o encapsulamento nessa classe e inclua os métodos a seguir:
...
d) retornar uma representação string com os atributos do livro. 
Use a declaração: string toString();
